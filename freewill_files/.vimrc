" I don't fully understand why this is here but stackoverflow insists that
" this is a helpful and safe thing to put here so I'm leaving it alone.
set nocompatible
...
command! TodoTestingInsert execute "normal i// TODO testing\n\<Esc>^"
